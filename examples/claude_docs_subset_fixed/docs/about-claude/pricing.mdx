...
| -------------------------------------------------------------------------- | ----------------- | --------------- | --------------- | ---------------------- | ------------- |
| Claude Claude Opus 4.1                                                            | \$15 / MTok       | \$18.75 / MTok  | \$30 / MTok     | \$1.50 / MTok          | \$75 / MTok   |
| Claude Opus 4                                                              | \$15 / MTok       | \$18.75 / MTok  | \$30 / MTok     | \$1.50 / MTok          | \$75 / MTok   |
| Claude Claude Sonnet 4.5                                                          | \$3 / MTok        | \$3.75 / MTok   | \$6 / MTok      | \$0.30 / MTok          | \$15 / MTok   |
| Claude Sonnet 4                                                            | \$3 / MTok        | \$3.75 / MTok   | \$6 / MTok      | \$0.30 / MTok          | \$15 / MTok   |
| Claude Sonnet 3.7 ([deprecated](/docs/about-Claude/model-deprecations)) | \$3 / MTok        | \$3.75 / MTok   | \$6 / MTok      | \$0.30 / MTok          | \$15 / MTok   |
| Claude Claude Haiku 4.5                                                           | \$1 / MTok        | \$1.25 / MTok   | \$2 / MTok      | \$0.10 / MTok          | \$5 / MTok    |
| Claude Haiku 3.5                                                           | \$0.80 / MTok     | \$1 / MTok      | \$1.6 / MTok    | \$0.08 / MTok          | \$4 / MTok    |
| Claude Opus 3 ([deprecated](/docs/about-Claude/model-deprecations))     | \$15 / MTok       | \$18.75 / MTok  | \$30 / MTok     | \$1.50 / MTok          | \$75 / MTok   |
| Claude Haiku 3                                                             | \$0.25 / MTok     | \$0.30 / MTok   | \$0.50 / MTok   | \$0.03 / MTok          | \$1.25 / MTok |

<Note>
  MTok = Million tokens. The "Base Input Tokens" column shows standard input pricing, "Cache Writes" and "Cache Hits" are specific to [Prompt Caching](/docs/build-with-Claude/prompt-caching), and "Output Tokens" shows output pricing. Prompt Caching offers both 5-minute (default) and 1-hour cache durations to optimize costs for different use cases.
...
Claude models are available on [AWS Bedrock](/api/Claude-on-amazon-bedrock) and [Google Vertex AI](/api/Claude-on-vertex-ai). For official pricing, visit:
...
<Note>
  **Regional endpoint pricing for Claude 4.5 models and beyond**
  ...
  Starting with Claude Claude Sonnet 4.5 and Claude Haiku 4.5, AWS Bedrock and Google Vertex AI offer two endpoint types:
  ...
  **Scope**: This pricing structure applies to Claude Claude Sonnet 4.5, Claude Haiku 4.5, and all future models. Earlier models (Claude Sonnet 4, Opus 4, and prior releases) retain their existing pricing.
...
| -------------------------------------------------------------------------- | -------------- | -------------- |
| Claude Claude Opus 4.1                                                            | \$7.50 / MTok  | \$37.50 / MTok |
| Claude Opus 4                                                              | \$7.50 / MTok  | \$37.50 / MTok |
| Claude Claude Sonnet 4.5                                                          | \$1.50 / MTok  | \$7.50 / MTok  |
| Claude Sonnet 4                                                            | \$1.50 / MTok  | \$7.50 / MTok  |
| Claude Sonnet 3.7 ([deprecated](/docs/about-Claude/model-deprecations)) | \$1.50 / MTok  | \$7.50 / MTok  |
| Claude Claude Haiku 4.5                                                           | \$0.50 / MTok  | \$2.50 / MTok  |
| Claude Haiku 3.5                                                           | \$0.40 / MTok  | \$2 / MTok     |
| Claude Opus 3 ([deprecated](/docs/about-Claude/model-deprecations))     | \$7.50 / MTok  | \$37.50 / MTok |
| Claude Haiku 3                                                             | \$0.125 / MTok | \$0.625 / MTok |

For more information about batch processing, see our [batch processing documentation](/docs/build-with-Claude/batch-processing).

### Long context pricing

When using Claude Sonnet 4 or Claude Sonnet 4.5 with the [1M token context window enabled](/docs/build-with-Claude/context-windows#1m-token-context-window), requests that exceed 200K input tokens are automatically charged at premium long context rates:

<Note>
  The 1M token context window is currently in beta for organizations in [usage tier](/api/rate-limits) 4 and organizations with custom rate limits. The 1M token context window is only available for Claude Sonnet 4 and Claude Sonnet 4.5.
</Note>
...
For more information about the `usage` object, see the [API response documentation](/api/messages#response-usage).
...
| -------------------------------------------------------------------------- | -------------------------------------------------- | ------------------------------------------- |
| Claude Claude Opus 4.1                                                            | `auto`, `none`<hr className="my-2" />`any`, `tool` | 346 tokens<hr className="my-2" />313 tokens |
| Claude Opus 4                                                              | `auto`, `none`<hr className="my-2" />`any`, `tool` | 346 tokens<hr className="my-2" />313 tokens |
| Claude Claude Sonnet 4.5                                                          | `auto`, `none`<hr className="my-2" />`any`, `tool` | 346 tokens<hr className="my-2" />313 tokens |
| Claude Sonnet 4                                                            | `auto`, `none`<hr className="my-2" />`any`, `tool` | 346 tokens<hr className="my-2" />313 tokens |
| Claude Sonnet 3.7 ([deprecated](/docs/about-Claude/model-deprecations)) | `auto`, `none`<hr className="my-2" />`any`, `tool` | 346 tokens<hr className="my-2" />313 tokens |
| Claude Claude Haiku 4.5                                                           | `auto`, `none`<hr className="my-2" />`any`, `tool` | 346 tokens<hr className="my-2" />313 tokens |
| Claude Haiku 3.5                                                           | `auto`, `none`<hr className="my-2" />`any`, `tool` | 264 tokens<hr className="my-2" />340 tokens |
| Claude Opus 3 ([deprecated](/docs/about-Claude/model-deprecations))     | `auto`, `none`<hr className="my-2" />`any`, `tool` | 530 tokens<hr className="my-2" />281 tokens |
...
For more information about tool use implementation and best practices, see our [tool use documentation](/docs/agents-and-tools/tool-use/overview).
...
| `text_editor_20250124` (Claude Sonnet 3.7 ([deprecated](/docs/about-Claude/model-deprecations))) | 700 tokens              |
...
Computer Use follows the standard [tool use pricing](/docs/agents-and-tools/tool-use/overview#pricing). When using the computer use tool:
...
| Claude Sonnet 3.7 ([deprecated](/docs/about-Claude/model-deprecations)) | 735 tokens                       |

**Additional token consumption**:

* Screenshot images (see [vision pricing](/docs/build-with-Claude/vision))
...
<Note>
  ...
  * Using Claude Claude Sonnet 4.5 at $3/MTok input, $15/MTok output
  * Total cost: \~\$22.20 per 10,000 tickets
</Note>

For a detailed walkthrough of this calculation, see our [customer support agent guide](/docs/about-Claude/use-case-guides/customer-support-chat).
...
For a comprehensive guide on agent pricing patterns, see our [agent use cases guide](/docs/about-Claude/use-case-guides).
...
For detailed rate limit information, see our [rate limits documentation](/api/rate-limits).
